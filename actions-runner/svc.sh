...
SVC_NAME="actions.runner.koagonzalo11-elparadisogonzalo-monorepo.DESKTOP-M9TA6OT.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (koagonzalo11-elparadisogonzalo-monorepo.DESKTOP-M9TA6OT)"
